...
public class DlgComboLeg extends JDialog
	...
	public DlgComboLeg( Vector<ComboLeg> comboLegs, String orderExchange, JDialog owner )
		{
		super( owner, true);
		...
		m_addLeg.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e) { onAddLeg(); }});
		m_removeLeg.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e) { onRemoveLeg(); }});
	...
	public void onRemoveLeg()
		...
		try
			...
			{
			reportError( "Error - onRemoveLeg()", e );
			return;
			}
		}
...
class ComboLegModel extends AbstractTableModel
	...
	synchronized public Object getValueAt( int r, int c )
		...
		switch ( c )
			{
			case 0:		return Integer.toString(leg.m_conId);
			case 1:		return Integer.toString(leg.m_ratio);
			case 2:		return leg.m_action;
			case 3:		return leg.m_exchange;
			case 4:		return Integer.toString(leg.m_openClose);
			case 5:		return Integer.toString(leg.m_shortSaleSlot);
			case 6:		return leg.m_designatedLocation;
			default:	return "";
			}
		}
	...
	public String getColumnName(int c)
		...
		switch (c)
			...
			case 4:		return "Open/Close";
			case 5:		return "Short Sale Slot";
			case 6:		return "Designated Location";
			default:	return null;
			}
		}

	public Vector<ComboLeg> comboLegModel() { return m_allData; }
	}
