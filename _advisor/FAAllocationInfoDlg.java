...
public class FAAllocationInfoDlg extends JDialog {
    SBGridBagPanel mainJPanel = new SBGridBagPanel();
    SBGridBagPanel faGroupJPanel = new SBGridBagPanel();
    SBGridBagPanel faProfileJPanel = new SBGridBagPanel();
    ...
    private DlgOrder m_parent;

    public FAAllocationInfoDlg(DlgOrder dlg) {
        super(dlg, false);
        m_parent = dlg;
        try {
            jbInit();
